...
public class Test008Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images.setImageResource(R.drawable.step2b2);
        topics.setText("Step2b(2)");
    ...
    public void toRun(View v) {
        ...
        switch (v.getId()) {
            case R.id.previous:
                it.setClass(this, Test007Activity.class);
                break;
            case R.id.stop:
